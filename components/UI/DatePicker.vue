  ...
  <div class="relative">
    ...
    <div class="relative">
      <input
        ...
        :disabled="disabled"
        :class="[
          'w-full pl-4 pr-10 py-2.5 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none transition-colors duration-200 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-300',
